...
--@Descripción:  Validador  ejercicio práctico 05 -01
...
Prompt =========================================================
Prompt Iniciando validador - Ejercicio práctico 09
Prompt Presionar Enter si los valores configurados son correctos.
Prompt De lo contrario editar el script s-07-validador-main.sql
...
accept p_instance_name default '&&p_instance_name' prompt 'Nombre de la instancia [&&p_instance_name]: '
