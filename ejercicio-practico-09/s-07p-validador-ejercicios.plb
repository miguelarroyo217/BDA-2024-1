...
exec spv_print_ok('Probando modo dedicado @&&p_instance_name&&suffix');
connect sys/&&p_sys_password@&&p_instance_name&&suffix as sysdba
set serveroutput on
exec spv_print_ok('Test modo dedicado @&&p_instance_name&&suffix');
define suffix='_pooled'
exec spv_print_ok('Probando modo pooled @&&p_instance_name&&suffix');
connect sys/&&p_sys_password@&&p_instance_name&&suffix as sysdba
set serveroutput on
exec spv_print_ok('Test modo pooled @&&p_instance_name&&suffix');
exec spv_print_ok('Detener y hacer reset del pool');
define suffix='_dedicated'
connect sys/&&p_sys_password@&&p_instance_name&&suffix as sysdba
set serveroutput on
