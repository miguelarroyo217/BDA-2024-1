...
Prompt =========================================================
Prompt Iniciando validador - Ejercicio práctico 07
...
accept p_nombre default '&&p_nombre' prompt 'Nombre del alumno o prefijo empleado para crear al usuario <nombre>07: [&&p_nombre]: '
accept p_usr_password default '&&p_usr_password' prompt 'Proporcionar el password del usuario <nombre>07 [Configurado en script]: ' hide
