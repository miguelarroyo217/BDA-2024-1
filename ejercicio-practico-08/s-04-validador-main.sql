...
Prompt =========================================================
Prompt Iniciando validador - Ejercicio práctico 08
...
accept p_nombre default '&&p_nombre' prompt 'Nombre del alumno o prefijo empleado para crear al usuario <nombre>08: [&&p_nombre]: '
accept p_sys_password default '&&p_sys_password' prompt 'Proporcionar el password de sys [Configurado en script]: ' hide

define p_script_validador='s-04p-validador-ejercicios.plb'
